jQuery(document).ready(function($) {
    'use strict';
    var this_obj = software_it_company_plugin_activate_plugin;

    $('#Mizan_Demo_Importor_editor .plugin-activation-redirect a').addClass('mdi-redirect-to-dashboard');

    $(document).on('click', '.software-it-company-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message software-it-company-plugin-install');
                button.addClass('button-primary software-it-company-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.software-it-company-recommended-plugins .software-it-company-activation-note').css('display','block');
    ...
    $(document).on('click', '.software-it-company-plugin-activate', function(event) {
