 ...
 */
class Software_IT_Company_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'software-it-company' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'software-it-company-customize-controls' );
		wp_enqueue_script( 'software-it-company-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Software_IT_Company_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
