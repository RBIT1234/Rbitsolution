 ...
 * @since 1.0.0
 */
class Software_IT_Company_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'software_it_company';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'software-it-company' ), $i ),
...
// Initialize.
$Software_IT_Company_Footer_Widgets = new Software_IT_Company_Footer_Widgets();